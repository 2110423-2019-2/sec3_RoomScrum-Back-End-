...
if (!config.MYSQL_PASSWORD)
  throw new Error("please config MYSQL_PASSWORD in .env");
if (!config.MYSQL_DATABASE)
  throw new Error("please config MYSQL_DATABASE in .env");
if (!config.MYSQL_TEST_DATABASE)
  throw new Error("please config MYSQL_TEST_DATABASE in .env");
